...
\begin{task}[points=1]{Differenzen- und Diffenrenzialquotient anwenden}
    ...
    \end{grayInfoBox}
    \begin{align*}
        \text{a) }& \text{Wie ist der Differenzenquotient definiert?}\\[0.5ex]
        \text{b) }& \text{Was unterscheidet den Diffenrenzialquotienten vom Differenzenquotienten?}\\
        \text{c) }& \text{Wann in welchen fällen sind Differenzialquotient und Differenzenquotient identisch über die gesamte Funktion?}\\[0.5ex]
        \text{d) }& \text{Differenzenquotient von: }f(x)=2x^3 \text{ mit }x\in\mathbb{R} [0;2]\\[0.5ex]
        \text{e) }& \text{Differenzialquotient von: }g(x)=x^2 \text{ mit }x\to1
    \end{align*}
\end{task}
% Aufgabe 2
\begin{task}[points=9]{Ganzrationale Funktionen ableiten (Potenz-, Faktor- und Summenregel)}
    \begin{grayInfoBox}
        Bilden Sie für jede der in a) bis f) gegebene Funktion die zugehöhrige Ableitung.
    \end{grayInfoBox}
    \begin{align*}
        \text{a) }& f(x)=3x^4-53\\[0.5ex]
        \text{b) }& g(x)=0,2x^5-2,5x^4+3x^2-2,79x+23\\[0.5ex]
        \text{c) }& h(t)=0,25x^4-0,5t^2+x^2-6t+5x-3\\
        \text{d) }& i(x)=\frac{2x^6-8x^4}{x^3+2x^2}\\[0.5ex]
        \text{e) }& w(u)=\frac{5u^6+ax^4-bu^2}{2au^2*(3a-5b)}\\[0.5ex]
        \text{f) }& v(l)=5l^{2,5}+l^2-2l^{-3,5}
    \end{align*}
        ...
        \begin{subfigure}[t]{.25\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, draw=red,very thick]{x^2};
                \end{axis}
            \end{tikzpicture}
            \caption*{\untickedbox}
        \end{subfigure}
        \begin{subfigure}[t]{.25\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, draw=red,very thick]{2*x};
                \end{axis}
            \end{tikzpicture}
        ...
        \begin{subfigure}[t]{.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, draw=accentcolor,very thick]{(x-1)^3+2};
                \end{axis}
            \end{tikzpicture}
            \caption*{$g(x)$}
        \end{subfigure}
        \begin{subfigure}[t]{.25\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, draw=red,very thick]{3*(x-1)^2};
                \end{axis}
            \end{tikzpicture}
            \caption*{\IfSolutionTF{\redtickedbox}{\untickedbox}}
        \end{subfigure}
        \begin{subfigure}[t]{.25\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, draw=red,very thick]{2*(x-1)};
                \end{axis}
            \end{tikzpicture}
            \caption*{\untickedbox}
        \end{subfigure}
        \begin{subfigure}[t]{.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, draw=red,very thick]{-3*(x-1)^2+2};
                \end{axis}
            \end{tikzpicture}
            \caption*{\untickedbox}
        \end{subfigure}
        ...
        \begin{subfigure}[t]{.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, draw=accentcolor,very thick]{.2 * (x)^2 * (x-2) * (x+2) - 2};
                \end{axis}
            \end{tikzpicture}
            \caption*{$h(x)$}
        \end{subfigure}
        \begin{subfigure}[t]{.25\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, draw=red,very thick]{x^3};
                \end{axis}
            \end{tikzpicture}
            \caption*{\untickedbox}
        \end{subfigure}
        \begin{subfigure}[t]{.25\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, draw=red,very thick]{-(0.8 * x^3 - 1.6 * x)};
                \end{axis}
            \end{tikzpicture}
            \caption*{\untickedbox}
        \end{subfigure}
...
\clearpage
% Aufgabe 4
\begin{task}[points=3]{Graph der Ableitungsfunktion einer gegebenen Funktion zeichnen}
    \begin{grayInfoBox}
    ...
    \begin{tikzpicture}
        ...
        \addplot[thick,samples=100, orange!50!black]{-3*sin(deg(x))};%
        \node[font=\small, orange!50!black]at(2.3cm,5.2cm){$f(x)$};
        \end{axis}
        \node[font=\small, anchor=north east] at (0cm,6.6cm){c)};
    \end{tikzpicture}
\end{task}
% Aufgabe 5
