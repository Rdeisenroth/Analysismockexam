...
=======
        f(x) & =3x^4-53                              \\[0.5ex]
        g(x) & =0,2x^5-2,5x^4+3x^2-2,79x+23          \\[0.5ex]
        h(t) & =0,25x^4-0,5t^2+x^2-6t+5x-3           \\
        i(x) & =\frac{2x^6-8x^4}{x^3+2x^2}           \\[0.5ex]
        w(u) & =\frac{5x^6+ax^4-bx^2}{2ax^2*(3a-5b)} \\[0.5ex]
        v(l) & =5l^{2,5}+l^2-2l^{-3,5}
>>>>>>> 934b97afd23b3e8340401d636ffc10d1e0fc46a8
    \end{align*}
