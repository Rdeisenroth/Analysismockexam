...
\begin{task}[points=9]{Ganzrationale Funktionen ableiten (Potenz-, Faktor- und Summenregel)}
    ...
    \begin{tikzpicture}[x=1cm, y=1cm]
        ...
        \draw[step=1cm, line width=.8pt, black!40!white] (0,0) grid (\textwidth,-15cm);
        ...
        \node[anchor= north west] at (0,0){%
            \textcolor{red}{%
                ...
                \topskip\baselineskip
                \setlength{\jot}{.5cm}
                $\begin{multlined}\textcolor{fgcolor}{\text{Platz für ihre Lösung:}}\IfSolutionT{\\[.5mm]\begin{aligned}
                                f'(x) & =12x^3                       \\
        ...
        \begin{subfigure}[t]{.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, samples=100, draw=\IfDarkModeTF{cyan}{accentcolor},very thick]{x^2-2};
                \end{axis}
            \end{tikzpicture}
            \caption*{$f(x)$}
        \end{subfigure}
        ...
        \begin{subfigure}[t]{.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, samples=100, draw=\IfDarkModeTF{cyan}{accentcolor},very thick]{(x-1)^3+2};
                \end{axis}
            \end{tikzpicture}
            \caption*{$g(x)$}
        \end{subfigure}
        ...
        \begin{subfigure}[t]{.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, samples=100, samples=100, draw=\IfDarkModeTF{cyan}{accentcolor},very thick]{.2 * (x)^2 * (x-2) * (x+2) - 2};
                \end{axis}
            \end{tikzpicture}
            \caption*{$h(x)$}
        \end{subfigure}
    ...
    \begin{subtask}[points=1]
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[thick,samples=100, smooth, \IfDarkModeTF{cyan}{blue}]{0.75*x^2-2.25*x-2};%
                \IfSolutionT{
                    \addplot[thick,samples=100, smooth, red]{1.5*x-2.25};
                    \node[font=\small, red]at(axis cs:2,1.7){$f'(x)$};
                }
                \node[font=\small, \IfDarkModeTF{cyan}{blue}]at(axis cs:-1.8,2.2){$f(x)$};
            \end{axis}
        \end{tikzpicture}
    \end{subtask}
    \begin{subtask}[points=4]
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[thick,samples=100, smooth, green!50!fgcolor]{(0.05*x^4+(1/15)*x^3-0.6*x^2)-1};%
                \IfSolutionT{
                    \addplot[thick,samples=100, smooth, red]{(1/5)*x*(x^2+x-6)};%
                    \node[font=\small, red]at(axis cs:2,1.7){$f'(x)$};
                }
                \node[font=\small, green!50!fgcolor]at(axis cs:3,-1.7){$f(x)$};
            \end{axis}
        \end{tikzpicture}
    \end{subtask}
    \begin{subtask}[points=2]
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[thick,samples=100, smooth, orange!50!fgcolor]{-3*sin(deg(x))};%
                \IfSolutionT{
                    \addplot[thick,samples=100, smooth, red]{-3*cos(deg(x))};%
                    \node[font=\small, red]at(axis cs:1.8,2){$f'(x)$};
                }
                \node[font=\small, orange!50!fgcolor]at(axis cs:-3,2){$f(x)$};
            \end{axis}
        \end{tikzpicture}
    \end{subtask}
\end{task}
        ...
        \begin{subfigure}[t]{.24\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \begin{axis}[
                    ...
                    \addplot[smooth, samples=100, draw=\IfDarkModeTF{cyan}{accentcolor},very thick]{(x+2)^3+2};
                \end{axis}
            \end{tikzpicture}
    ...
    \begin{minipage}[t]{.49\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \begin{axis}[
                ...
                \addplot[smooth, samples=100, draw=\IfDarkModeTF{cyan}{accentcolor},very thick]{x^3+0.5};
                \IfSolutionT{
                \addplot[smooth, draw=red,very thick]{3 * (x-1)+1.5};
                \addplot[smooth, draw=green!60!fgcolor,very thick]{-(1/3) * (x-1)+1.5};
                \node [red] at (axis cs:.8,-.8){$t_f$};
                \node [green!60!fgcolor] at (axis cs:1.8,.7){$n_f$};
...
\begin{task}[points=auto]{Monotonieverhalten + rel. Extremwerte}
            ...
            \begin{subfigure}[t]{.33\textwidth}
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[thick,samples=100, smooth, \IfDarkModeTF{cyan}{blue}]{0.7*x-2};%
                    \end{axis}
                \end{tikzpicture}
            ...
            \begin{subfigure}[t]{.33\textwidth}
                ...
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        \addplot[thick,samples=100, smooth, green!60!fgcolor]{0.1*x^3};%
                    \end{axis}
                \end{tikzpicture}
                %\caption*{\\ \parbox{0.9\textwidth}{\dotfill}}
            \end{subfigure}
    ...
    \begin{subtask}[points=8]
        ...
        \begin{tikzpicture}[x=1cm, y=1cm]
            ...
            \draw[step=1cm, line width=.8pt, black!40!white] (0,0) grid (\textwidth,-7cm);
            \IfSolutionT{
                \node[anchor= north west] at (0,0){%
                    \textcolor{red}{%
                        $\begin{aligned}
